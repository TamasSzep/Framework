...
void AABoundingBox::SerializeSB(Core::ByteVector& bytes) const
{
	Core::SerializeSB(bytes, Core::ToPlaceHolder(Minimum));
	Core::SerializeSB(bytes, Core::ToPlaceHolder(Maximum));
}

void AABoundingBox::DeserializeSB(const unsigned char*& bytes)
{
	Core::DeserializeSB(bytes, Core::ToPlaceHolder(Minimum));
	Core::DeserializeSB(bytes, Core::ToPlaceHolder(Maximum));
}
