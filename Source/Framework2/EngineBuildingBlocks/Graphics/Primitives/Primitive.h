...
namespace EngineBuildingBlocks
{
	namespace Graphics
	{
		...
		const VertexElement c_VertexBoneIndexVertexElement = { "BoneIndices", VertexElementType::Uint32, sizeof(unsigned), 4 };
		const VertexElement c_VertexBoneWeightVertexElement = { "BoneWeights", VertexElementType::Float, sizeof(float), 4 };
		...
		struct VertexInputLayout
		{
			...
			static VertexInputLayout GetDummy();
		...
		struct Vertex_SOA_Data
		{
			...
			void AddBoneData(const EngineBuildingBlocks::Animation::BoneData& boneData);
			void AddBoneData(EngineBuildingBlocks::Animation::BoneData&& boneData);
			void AddBoneData(const Core::SimpleTypeVectorU<glm::uvec4>& boneIndices,
			...
			const glm::uvec4* GetVertexBoneIndices() const;
			const glm::vec4* GetVertexBoneWeights() const;
