...
namespace EngineBuildingBlocks
{
	namespace Graphics
	{
		...
		public:
			...
			static RigidTransformation ViewToTransformation(const glm::mat4& viewMatrix);
			static glm::mat4 TransformationToView(const ScaledTransformation& transformation);
